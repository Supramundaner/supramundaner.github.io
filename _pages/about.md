...
<div class="cn-content" markdown="1">

我是[香港科技大学 (HKUST)](https://hkust.edu.hk/) [数据科学与技术 +AI](https://dsct.hkust.edu.hk/) 专业的三年级本科生。我的研究兴趣主要集中在机器学习和计算机视觉，特别是构建统一的 2D 和 3D 数据模型，以实现类似人类的对现实世界的理解。我最近的工作主要集中在 3D 视觉方面。我有幸在 [Prof. Chi-Keung Tang](https://cse.hkust.edu.hk/~cktang/bio.html) 和 [Prof. Yu-Wing Tai ](https://yuwingtai.github.io/) 的指导下进行计算机视觉方面的研究。

</div>

<h3 class="en-content">Recent News</h3>
<h3 class="cn-content">最新动态</h3>
...
*   **2025/06**: 参加 [南洋理工大学 (NTU)](https://www.ntu.edu.sg/) 的暑期交换项目。
*   **2025 Fall**: 期待在 [洛桑联邦理工学院 (EPFL)](https://www.epfl.ch/en/) 的交换项目。
